...
var Rsocket = new WebSocket('ws://' + window.location.hostname + ':9003/');
var Psocket = new WebSocket('ws://' + window.location.hostname + ':9004/');
...
canvasL.addEventListener('touchstart', function(e){         // 'touchstart' event in LeftCanvas
       ...
       canvasL.addEventListener('touchmove', function(e){
              ...
              sendData(throttle,ValueLimitter(throttle, 405-LJoyStickBall.y));
              sendData(yaw,ValueLimitter(yaw, LJoyStickBall.x-225));
              }, false)
   }, false)
...
canvasR.addEventListener('touchstart', function(e){         // 'touchstart' event in RightCanvas
       ...
       canvasR.addEventListener('touchmove', function(e){
              ...
              sendData(pitch,ValueLimitter(pitch,210-RJoyStickBall.y));
              sendData(roll,ValueLimitter(roll,RJoyStickBall.x-225));
